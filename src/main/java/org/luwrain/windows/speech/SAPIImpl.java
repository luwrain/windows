...
class SAPIImpl extends SAPIImpl_constants
{
	 ...
	 * @return	0 если успех, 1 - не выбран голосовой токен, 2 - возникла иная проблема с выбором голоса
	 */
	 ...
	 * @return	количество голосов, удовлетворяющих условию или -1 - если ошибка
	 */
	 ...
	 */
	public static int speak(String text) {return speak(text,SPF_ASYNC|SPF_IS_XML);}
}
